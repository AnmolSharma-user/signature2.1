  ...
  return (
    <>
      <SEOHead
        ...
        description="Resize photo for GATE 2026 exam to 5KB-200KB. Free tool with perfect dimensions & quality for your application."
        canonicalUrl="https://signatureresize.in/gate-photo-resize"
        keywords="GATE photo resize, GATE photograph size, GATE 2026 photo"
      />
